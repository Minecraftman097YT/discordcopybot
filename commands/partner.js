...
exports.run = (bot, message, args) => {
  const Partner = new Discord.RichEmbed()
    ...
    .addField(":performing_arts: Self Roles \n\n:speech_balloon: Viele Chats", "Und")
    .addField(":loud_sound: Viele Sprachkanäle \n\n:heavy_plus_sign: Join4Create", "Und")
    .addField(":game_die: Viele Minigames \n\n:handshake: Partnerschaften ab 80 Usern.", "Und") 
    .addField(":tada: Viele Giveaways \n\n<a:Alarm:827807392589676564> Guten Support", "Und")
    .addField("\n\n<a:Stern:827807184887873538> Aktive Community \n\n:no_entry_sign: Keine @everyone Pings", "Und noch")
